...
var i_32365 = (0);
while(true){
if((i_32365 < arr.length)){
(arr[i_32365] = null);

var G__32366 = (i_32365 + (1));
i_32365 = G__32366;
continue;
} else {
}
...
var i_32373 = (self__.level + (1));
while(true){
if((i_32373 <= (new_level + (1)))){
(update[i_32373] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_32375 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_32375[i]));
} else {
x__$2.forward.push((((i < links_32375.length))?(links_32375[i]):null));
}

if((i < links_32375.length)){
(links_32375[i] = x__$2);
} else {
links_32375.push(x__$2);
}
...
var i_32379 = (0);
while(true){
if((i_32379 <= self__.level)){
var links_32380 = (update[i_32379]).forward;
if((x__$1 === (((i_32379 < links_32380.length))?(links_32380[i_32379]):null))){
(links_32380[i_32379] = (x__$1.forward[i_32379]));

var G__32381 = (i_32379 + (1));
i_32379 = G__32381;
continue;
} else {
var G__32382 = (i_32379 + (1));
i_32379 = G__32382;
continue;
}
} else {
