...
var G__38080 = o;
reagent.impl.template.goog$module$goog$object.set(G__38080,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__38098__delegate = function (args){
...
while (G__38099__i < G__38099__a.length) {G__38099__a[G__38099__i] = arguments[G__38099__i + 0]; ++G__38099__i;}
  args = new cljs.core.IndexedSeq(G__38099__a,0,null);
} 
return G__38098__delegate.call(this,args);};
G__38098.cljs$lang$maxFixedArity = 0;
G__38098.cljs$lang$applyTo = (function (arglist__38100){
var args = cljs.core.seq(arglist__38100);
return G__38098__delegate(args);
});
...
var G__38081 = o;
reagent.impl.template.goog$module$goog$object.set(G__38081,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__38101__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__38102__i < G__38102__a.length) {G__38102__a[G__38102__i] = arguments[G__38102__i + 0]; ++G__38102__i;}
  args = new cljs.core.IndexedSeq(G__38102__a,0,null);
} 
return G__38101__delegate.call(this,args);};
G__38101.cljs$lang$maxFixedArity = 0;
G__38101.cljs$lang$applyTo = (function (arglist__38103){
var args = cljs.core.seq(arglist__38103);
return G__38101__delegate(args);
});
...
var G__38082 = props;
var G__38082__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38082,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__38082);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38082__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__38083 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38083,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__38083;
}
})(),id_class);
...
var G__38084 = (cljs.core.count(argv) - first_child);
switch (G__38084) {
case (0):
...
var vec__38085 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38085,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38085,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38085,(2),null);
...
var temp__5757__auto___38105 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___38105 == null)){
} else {
var key_38106 = temp__5757__auto___38105;
...
var temp__5757__auto___38107 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___38107 == null)){
} else {
var key_38108 = temp__5757__auto___38107;
(jsprops.key = key_38108);
}
...
var temp__5757__auto___38109 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___38109 == null)){
} else {
var key_38110 = temp__5757__auto___38109;
(jsprops.key = key_38110);
}
...
var temp__5757__auto___38111 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___38111 == null)){
} else {
var key_38112 = temp__5757__auto___38111;
(jsprops.key = key_38112);
}
...
var temp__5757__auto___38113 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___38113 == null)){
} else {
var key_38114 = temp__5757__auto___38113;
(jsprops.key = key_38114);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38088_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__38088_SHARP_);
}),s));
});
...
break;
default:
var G__38118 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__38119 = compiler;
v = G__38118;
compiler = G__38119;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template38095 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template38095 = (function (opts,id,fn_to_element,parse_fn,meta38096){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template38095.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_38097,meta38096__$1){
var self__ = this;
var _38097__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template38095(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta38096__$1));
}));

(reagent.impl.template.t_reagent$impl$template38095.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_38097){
var self__ = this;
var _38097__$1 = this;
return self__.meta38096;
}));

(reagent.impl.template.t_reagent$impl$template38095.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template38095.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template38095.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template38095.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template38095.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template38095.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta38096","meta38096",140045724,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template38095.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template38095.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template38095");

(reagent.impl.template.t_reagent$impl$template38095.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template38095");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template38095.
 */
reagent.impl.template.__GT_t_reagent$impl$template38095 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template38095(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta38096){
return (new reagent.impl.template.t_reagent$impl$template38095(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta38096));
});

}

return (new reagent.impl.template.t_reagent$impl$template38095(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
