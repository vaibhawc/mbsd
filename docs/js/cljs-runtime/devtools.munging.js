...
var temp__5751__auto____$1 = (o27174["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o27175 = temp__5751__auto____$1;
return (o27175["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26701__auto__ = f;
return (o__26701__auto__["toString"]).call(o__26701__auto__);
} else {
return "";
}
}catch (e27180){var _ = e27180;
return "";
}});
...
try{var o__26701__auto___27731 = t;
(o__26701__auto___27731["cljs$lang$ctorPrWriter"]).call(o__26701__auto___27731,t,writer);
}catch (e27184){var __27732 = e27184;
}
...
var char_code = (function (){var o__26701__auto__ = (new String(char$));
return (o__26701__auto__["charCodeAt"]).call(o__26701__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26701__auto__ = String;
return (o__26701__auto__["fromCharCode"]).call(o__26701__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27205 = num_code;
switch (G__27205) {
case (1):
return (185);
...
var o__26701__auto__ = String;
return (o__26701__auto__["fromCharCode"]).call(o__26701__auto__,superscript_code);
});
/**
...
}catch (e27219){var _e__26716__auto__ = e27219;
return false;
}})())){
...
var vec__27221 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27221,(0),null);
...
var G__27769 = (i__4865__auto___27767 + (1));
i__4865__auto___27767 = G__27769;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27238){
var vec__27240 = p__27238;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27240,(0),null);
...
var G__27774 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__27775 = cljs.core.butlast(remaining_tokens);
name_tokens = G__27774;
remaining_tokens = G__27775;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27232){
var G__27233 = cljs.core.first(seq27232);
var seq27232__$1 = cljs.core.next(seq27232);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27233,seq27232__$1);
}));
...
var vec__27270 = cljs.core.split_with((function (p1__27266_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__27266_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27270,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27270,(1),null);
...
var vec__27287 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27287,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27287,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__27781 = cljs.core.rest(remaining_tokens);
var G__27782 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__27781;
name_tokens = G__27782;
continue;
} else {
...
var vec__27300 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27300,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27300,(1),null);
var vec__27303 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27303,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27303,(1),null);
var vec__27306 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27306,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27306,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27306,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27306,(3),null);
...
var vec__27323 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27323,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27323,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27323,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27323,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27323,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27323,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__27334 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27334,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27334,(1),null);
var vec__27337 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27337,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27337,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__27407 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__27407) : devtools.munging.parse_fn_info_deep.call(null,G__27407));
})()));
}
} else {
return fn_info;
...
var G__27832 = (arity + (1));
var G__27833 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27421){
var vec__27422 = p__27421;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27422,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27422,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27426_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__27426_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27427_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__27427_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27433){
var vec__27434 = p__27433;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27434,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27430){
var G__27431 = cljs.core.first(seq27430);
var seq27430__$1 = cljs.core.next(seq27430);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27431,seq27430__$1);
}));
...
var map__27469 = options;
var map__27469__$1 = cljs.core.__destructure_map(map__27469);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27469__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27469__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27469__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27469__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27470 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27470,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27470,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27470,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27470,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27470,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27470,(5),null);
...
var o__26701__auto__ = f;
return (o__26701__auto__["getBasis"]).call(o__26701__auto__);
});
/**
...
}catch (e27565){var _e__26716__auto__ = e27565;
...
var G__27914 = (obj[cljs.core.first(path)]);
var G__27915 = cljs.core.rest(path);
obj = G__27914;
path = G__27915;
continue;
} else {
...
var _STAR_ = (function (accum,p__27616){
var vec__27617 = p__27616;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27617,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27617,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27636){
var vec__27639 = p__27636;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27639,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27639,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27639,(2),null);
...
var post_process = (function (p__27679){
var vec__27681 = p__27679;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27681,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27681,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27667_SHARP_){
return (obj[cljs.core.first(p1__27667_SHARP_)]);
}),sorted_matches);
