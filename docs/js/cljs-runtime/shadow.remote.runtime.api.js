...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_32480 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_32480(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_32484 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_32484(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_32485 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_32485(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_32487 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_32487(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_32488 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_32488(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_32489 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_32489(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__32478,callback){
var map__32479 = p__32478;
var map__32479__$1 = cljs.core.__destructure_map(map__32479);
var input = map__32479__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32479__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32479__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
